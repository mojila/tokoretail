! function (e) {
    ...
    a.active = !1, a.webcam = null, a.canvas = null, a.ctx = null, a.decoder = null, a.setCanvas = function () {
        ...
        var i = !1;
        window.iOS ? a.webcam = document.querySelector("img") : a.webcam = document.querySelector("video"), a.setCanvas(), a.decoder = new Worker("decoder.min.js"), window.iOS ? e() : a.webcam.addEventListener("play", function (t) {
            i || (e(), i = !0)
    ...
    t.install = o, t.applyUpdate = a, t.update = i
}, function (e, t, n) {
    "use strict";
